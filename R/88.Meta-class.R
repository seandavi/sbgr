...
paired_end_v1 <- PairedEndV1SingleEnum <- setSingleEnum("PairedEndV1", .paired_end)
...
Metadata <- setRefClass("Metadata",
                        fields = list(
                            ...
                            paired_end = "PairedEndV1SingleEnum",
                            extra = "listORNULL"
                        ),
                        methods = list(
                            initialize = function(file_type = NA,
                                ...
                                paired_end <<- paired_end_v1(tolower(paired_end))
...
paired_end_enum <- setSingleEnum("PairedEnd", c("1", "2"))
...
quality_scale_enum <- setSingleEnum("QualityScale",
                                    c("sanger", "illumina13", "illumina15", "illumina18", "solexa"))
...
access_level_enum <- setSingleEnum("AccessLevel", c("Controlled", "Open"))
...
#' 
#' @export MetaSchema
MetaSchema <- setRefClass("MetaSchema",
                          fields = lst,
                          methods = list(
                              initialize = function(
